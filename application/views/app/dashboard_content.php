										...
										<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
											...
											<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('assets/media/patterns/vector-1.png')">
												...
												<div class="card-header pt-5">
													...
													<div class="card-title d-flex flex-column">
														...
														<!--begin::Subtitle-->
														<? if($total_order <> '0'){ ?>
														<span class="text-white opacity-75 pt-1 fw-semibold fs-6">You have <?=$total_order?> order</span>
														<? } else { ?>
														<span class="text-white opacity-75 pt-1 fw-semibold fs-6">You dont have any order</span>
														<? } ?>
														<!--end::Subtitle-->
													</div>
													<!--end::Title-->
												...
												<div class="card-body d-flex align-items-end pt-0">
													...
													<div class="d-flex align-items-center flex-column mt-3 w-100">
														<div class="d-flex justify-content-between fw-bold fs-6 text-white opacity-75 w-100 mt-auto mb-2">
															<a href="#" class="btn btn-secondary btn-sm add-new-order">Add New Order</a>
														</div>
											...
											<div class="card card-flush h-md-50 mb-5 mb-xl-10">
												...
												<div class="card-header pt-5">
													...
													<div class="card-title d-flex flex-column">
														<!--begin::Amount-->
														<span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2"><?=$total_kit?></span>
														<!--end::Amount-->
														<!--begin::Subtitle-->
														<span class="text-gray-500 pt-1 fw-semibold fs-6">Kit's Template</span>
														<!--end::Subtitle-->
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="card-body d-flex flex-column justify-content-end pe-0">
													<!--begin::Title-->
													<span class="fs-6 fw-bolder text-gray-800 d-block mb-2">Kit’s List</span>
													<!--end::Title-->
													<!--begin::Users group-->
													<? if( !$total_kit){ ?>
													<b>Kit Not Available</b>
													<? } else { ?>
													...
													<!-- 	<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Alan Warden">
														...
														<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="<?=$item['name']?>">
															<img alt="Pic" src="<?=base_url()?>uploads/kit/<?=$item['filename']?>" />
														</div>
														<? } ?>
														...
														<a href="<?=base_url('app/kit')?>" class="symbol symbol-35px symbol-circle">
															<span class="symbol-label bg-dark text-gray-300 fs-8 fw-bold">+<?=$total_kit?></span>
														</a>
													</div>
													<? } ?>
													<!--end::Users group-->
												...
												<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('assets/media/stock/900x600/42.png')">
													...
													<div class="mb-10">
														...
														<span class="position-relative d-inline-block text-danger">
															<a href="<?=base_url('app/kit')?>" class="text-danger opacity-75-hover">Jersey</a>
															<!--begin::Separator-->
