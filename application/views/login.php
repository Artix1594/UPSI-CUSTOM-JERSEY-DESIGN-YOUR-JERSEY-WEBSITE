...
<body class="index-page">
  ...
  <main class="main">
    ...
    <!-- Contact Section -->
    <section id="contact" class="contact section" style="background-color:rgb(230, 230, 230)">
        ...
        <div class="row gy-4">
          <div class="col-lg-6 ">
            <div class="row gy-4">
              ...
              <div class="col-lg-12">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
              ...
              <div class="col-md-6">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="300" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
              ...
              <div class="col-md-6">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="400" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
          ...
          <div class="col-lg-6">
            <form action="<?=base_url('main/loginProcess')?>" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="500" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
              <div class="row gy-4">
                ...
                <div class="col-md-12 text-center">
                  ...
                  <button type="submit" style="background-color:rgb(250, 0, 0)">Login</button>
                </div>
