...
<head>
  ...
  .text-with-stroke {
    ...
    text-shadow: 0 0 5px black, 0 0 10px black, 0 0 20px black; /* Optional glow effect */
  }
  </style>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container d-flex flex-column align-items-center">
        <h2 class="text-with-stroke" data-aos="fade-up" data-aos-delay="100">
        Customise Your <span style="color: red;">Idea</span> Into <span style="color: red;">Reality</span>
        </h2>
        <!-- <p data-aos="fade-up" data-aos-delay="200">Customise Your Idea Into Reality</p> -->
        <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
          <a href="#contact" class="btn-get-started" style="background-color:rgb(255, 0, 0)">Custom Your Jersey</a>
        </div>
      </div>
    ...
    <img src="<?=base_url()?>/assets-landing/img/2.png?v=<?= time() ?>" alt="Portfolio">
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p style="color:rgb(0, 0, 0);">Register To Start Your Custom Your Jersey</p>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          <div class="col-lg-6 ">
            <div class="row gy-4">
              ...
              <div class="col-lg-12">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200" style="border-radius: 7px;">
                  <i class="bi bi-geo-alt"></i>
                  <h3>Address</h3>
                  <p>Universiti Pendidikan Sultan Idris, 35900, Tanjong Malim, Perak.</p>
                </div>
              </div><!-- End Info Item -->

              <div class="col-md-6">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="300" style="border-radius: 7px;">
              ...
              <div class="col-md-6">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="400" style="border-radius: 7px;">
                  <i class="bi bi-envelope"></i>
                  <h3>Email Us</h3>
                  <p>ucjersey7@gmail.com</p>
                </div>
              </div><!-- End Info Item -->
          ...
          <div class="col-lg-6">
            <form action="<?=base_url('main/doCreateAccount')?>" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="500" style="border-radius: 7px;">
              <div class="row gy-4">

                <div class="col-md-6">
                  <label>Your Name</label>
                  <input type="text" name="name" class="form-control" required="" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
                </div>

                <div class="col-md-6">
                  <label>Your Email</label>
                  <input type="email" class="form-control" name="email" required="" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
                </div>

                <div class="col-md-12">
                  <label>Password</label>
                  <input type="password" class="form-control" name="password" required="" style="border-radius: 7px; background-color:rgb(255, 255, 255)">
                </div>
                ...
                <div class="col-md-12 text-center">
                  ...
                  <button type="submit" style="background-color: red; color: white;">Create an account</button>
                </div>
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            ...
            <img src="<?=base_url()?>assets/logo/logo-tran.png" alt="">
          </a>
          <div class="footer-contact pt-3">
            <p>Universiti Pendidikan Sultan Idris</p>
            <p>35900, Tanjong Malim, Perak.</p>
            <p class="mt-3"><strong>Phone:</strong> <span>+601151557286</span></p>
            <p><strong>Email:</strong> <span>ucjersey7@gmail.com</span></p>
          </div>
        ...
        <div class="col-lg-4 col-md-12 footer-newsletter">
          <h4>About UCJ</h4>
          <p>UPSI Custom Jersey Website is your platform to design and order personalized jerseys. We offer high-quality design, affordable, and stylish jerseys to your needs.</p>
